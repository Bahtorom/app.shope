                            ...
                            <div class="menu-main h-full max-lg:hidden">
                                <ul class="flex items-center gap-8 h-full">
                                    <li class="h-full relative">
                                        <a href="#!" class="text-button-uppercase duration-300 h-full flex items-center justify-center"> Apple </a>
                                                ...
                                                <div class="flex justify-between py-8">
                                                    <div class="nav-link basis-2/3 grid grid-cols-4 gap-y-8">
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer">IPhone 17 </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> IPhone 16 </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> IPhone 15  </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> IPhone 14 </a>
                                                                </li>
                                                                <li>
                                                                    <a href={{ route('shope') }} class="link text-secondary duration-300 view-all-btn"> All </a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> MacBook Air </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> MacBook Pro </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> iMac </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 view-all-btn"> All </a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                        <div class="nav-item">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Watch Ultra 3 </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Watch Series 11 </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Watch SE 3  </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 cursor-pointer"> Watch Series 10 </a>
                                                                </li>
                                                                <li>
                                                                    <a href="shop-breadcrumb1.html" class="link text-secondary duration-300 view-all-btn"> All</a>
                                                                </li>
                                ...
                                @auth
                                    ...
                                    <div class="user-icon flex items-center justify-center cursor-pointer">
                                        ...
                                        <div class="login-popup absolute top-[74px] w-[320px] p-7 rounded-xl bg-white box-shadow-small">
                                            ...
                                            <a href='#!' class="button-main w-full text-center ">Профиль</a>
                                            <a href='#!' class="button-main w-full text-center ">Баланс</a>
